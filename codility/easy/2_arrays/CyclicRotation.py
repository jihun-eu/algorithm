...
# Careful of exceptions. Lots of conditions needed.
# At first, I did't consider if input_list would be empty_list.
# Second, missed that list could have only one element.
# Finally, with those exceptions, it functions well.